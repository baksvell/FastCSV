# Исправление проблемы Small (10 rows)

## Проблема

Small (10 rows): **1.52x-1.60x медленнее** стандартного csv (0.01ms -> 0.02ms)
...
После исправления Small (10 rows) должен использовать fallback к std_csv и показывать лучшую производительность (близко к 1.0x или даже быстрее).
